...
<a
    ...
    <header className="bg-base-200/90 backdrop-blur-sm sticky top-0 z-50 shadow-md">
      ...
      >
        ...
        <div
          className="navbar-center justify-start md:justify-center flex-1 text-3xl p-1 underline"
        >
          <a
            href="#home"
      ...
      >
        ...
        <div className="hero-content text-center">
          <div className="max-w-xl">
            <h1
              className="mb-4 text-3xl md:text-5xl text-center text-white text-shadow-black text-shadow-lg font-bold"
            >
              Das Versiegeln der Tore: <br />
              Rinaboths letzte Hoffnung
            </h1>
            <p
              className="mb-4 text-lg md:text-2xl text-center text-white text-shadow-black text-shadow-sm font-semibold tracking-wide"
            >
      ...
      >
        <div className="container mx-auto px-4 md:px-50">
          ...
          <div className="w-full flex flex-col lg:flex-row gap-10">
            ...
            <article
              className="gap-4 p-6 bg-base-100 rounded-3xl shadow-xl border border-primary/10 flex flex-col"
            >
              ...
              <div className="text-center self-start flex-1">
                <h3 className="text-3xl font-serif text-secondary mb-2">Avra</h3>
            ...
            >
              ...
              <div className="text-center self-start flex-1">
                <h3 className="text-3xl font-serif text-secondary mb-2">Lahar</h3>
                <p className="text-md opacity-80 leading-relaxed">
      ...
      <section id="world" aria-labelledby="world-heading" className="py-16">
        <div className="container mx-auto px-4 md:px-10">
          ...
          <div className="text-lg max-w-3xl mx-auto mb-16 space-y-4">
            <p>
              Einst war Rinaboth ein Reich der Harmonie, dessen Name die Einheit
              von Mensch (Rina – Fluss) und Zwerg (Both – Stein) besiegelte.
              Doch vor 250 Jahren versiegte die königliche Blutlinie in einer
              Tragödie, die das Land in achtzig Jahre blutiger Erbfolgekriege
              stürzte.
            </p>
            <p>
              <strong>Die Ära der Sieben Lords:</strong> Seit 120 Jahren
              herrscht ein brüchiger Frieden. Sieben Lords teilen das Land unter
              sich auf. Während an der Oberfläche Turniere und
            ...
            <p>
              ...
              Bewohner von Rinaboth sind politische Wechsel Alltag geworden. Man
              wettet auf den nächsten Lord, während man die Last der Steuern
              trägt. Doch nun droht eine Gefahr, die kein politisches Ränkespiel
              lösen kann: Die flammenden Hügel beben, und die "Flüsse aus Stein"
          ...
          <div className="flex flex-col">
            <div className="text-center mb-3">
              <h3
                className="text-3xl text-center text-secondary font-semibold tracking-wide"
              >
            ...
            <ul
              className="list-disc list-inside md:w-max md:mx-auto mb-10 text-lg space-y-2"
            >
              <li>
                <strong>West Farthing</strong> – Lord Earnest Hellingway – „Das
                goldene Herz des Westmeeres“
              </li>
              <li>
                <strong>King's Rest</strong> – Lord Henry Altsworth – „König
                Heinrich“
              </li>
              <li><strong>Greenrun</strong> – Lord Tanner von Blackshire</li>
              <li><strong>Highfield</strong> – Acnologika</li>
              <li>
                <strong>Southchapel</strong> – Erzbischof Seaward Goodwill
              </li>
              <li><strong>Flaming Hills</strong> – Lord Ghrakun Donnerspeer</li>
              <li>
      ...
      >
        <div className="container mx-auto px-4 md:px-10">
          ...
          <div className="text-base md:text-lg max-w-3xl mx-auto mb-16 space-y-4">
            <p>
              <strong
                >Vor 250 Jahren: Das Ende der königlichen Blutlinie</strong
              >
            ...
            <p>
              ...
              legitimen Thronfolger kämpfen rivalisierende Adelsfamilien um die
              Macht, was zu achtzig Jahren blutiger Konflikte führt.
            </p>
            <p>
            ...
            <p>
              <strong>Gegenwart: Das Versiegeln der Tore</strong> – Drei Helden
              sammeln sich in den Hallen von Draken, um die Tore zu den
          ...
          <div className="flex flex-col">
            ...
            <figure className="flex items-center justify-center mb-10">
              ...
              <figcaption className="sr-only">
                Karte, die zeigt, wo sich die Helden derzeit in Draken befinden.
              </figcaption>
            </figure>
          </div>
        </div>
...
if (!rootElement) {
  throw new Error("Das React-Wurzelelement wurde nicht gefunden.");
}
